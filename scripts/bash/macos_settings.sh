...
apply_finder_settings() {
  ...
  defaults write com.apple.finder NewWindowTargetPath -string "file://${SETUP_PATH_DESKTOP}/"
...
apply_misc_settings() {
  ...
  mkdir -p "${SETUP_PATH_SCREENSHOTS}"

  log_info "Set screenshot location"
  defaults write com.apple.screencapture location "${SETUP_PATH_SCREENSHOTS}"
